...
public class Display extends SimulinkBlock {

	private static int num = 1;

	public Display(ISimulinkSystem parent, String name) {
		super(parent, name);
	}

	@Override
	public void initialize() {
		this.BLOCK_NAME = "Display";
		this.BLOCK_PATH = "simulink/Sinks/Display";
		if (name == null) {
