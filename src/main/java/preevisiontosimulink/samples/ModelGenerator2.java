...
public class ModelGenerator2 {
	...
	public static void generateModel(String modelName) {
		...
		system.addConnection(new SimulinkExternConnecntion(system.getBlock("Sine1").getOutPort(0), "Subsystem1",
				lastSubsystem.getPortPath("Inport1"), system, 0));
		system.addConnection(new SimulinkExternConnecntion(system.getBlock("Sine2").getOutPort(0), "Subsystem1",
				lastSubsystem.getPortPath("Inport2"), system, 0));
		system.addConnection(new SimulinkExternConnecntion(system.getBlock("Scope1").getInPort(0), "Subsystem1",
				lastSubsystem.getPortPath("Outport1"), system, 1));

		system.addConnection(new SimulinkConnection(lastSubsystem.getInPort("Inport1").getOutPort(0),
				lastSubsystem.getBlock("Gain1").getInPort(0), lastSubsystem));
		system.addConnection(new SimulinkConnection(lastSubsystem.getInPort("Inport2").getOutPort(0),
				lastSubsystem.getBlock("Gain2").getInPort(0), lastSubsystem));
		system.addConnection(new SimulinkConnection(lastSubsystem.getBlock("Gain1").getOutPort(0),
				lastSubsystem.getBlock("Add1").getInPort(0), lastSubsystem));
		system.addConnection(new SimulinkConnection(lastSubsystem.getBlock("Gain2").getOutPort(0),
				lastSubsystem.getBlock("Add1").getInPort(1), lastSubsystem));
		system.addConnection(new SimulinkConnection(lastSubsystem.getBlock("Add1").getOutPort(0),
