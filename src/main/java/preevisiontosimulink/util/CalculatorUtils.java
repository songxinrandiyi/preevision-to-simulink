...
public class CalculatorUtils {
     ...
     * @param material Das Material der Leitung ("Cu" für Kupfer, "Al" für Aluminium)
     * @param crossSectionArea Der Querschnittsbereich der Leitung in Quadratmillimetern (mm²)
     ...
     * @throws IllegalArgumentException wenn der Radius der Isolierung kleiner oder gleich dem Radius der Leitung ist
     */
    public static double calculateThermalResistance(double radiusWire, double radiusInsulation) {
        if (radiusInsulation <= radiusWire) {
            throw new IllegalArgumentException("Der Radius der Isolierung muss größer als der Radius der Leitung sein.");
        }
    ...
    /**
     * Berechnet den Radius in Millimetern (mm) aus der Querschnittsfläche in Quadratmillimetern (mm²).
     * 
     * @param crossSectionArea Die Querschnittsfläche in mm²
     * @return Der Radius in mm
     * @throws IllegalArgumentException wenn die Querschnittsfläche kleiner oder gleich null ist
     */
     ...
     * 
     * @param crossSectionArea Die Querschnittsfläche der Leitung in Quadratmillimetern (mm²)
     ...
     * @throws IllegalArgumentException wenn das Material weder "Cu" noch "Al" ist
     */
    public static double calculateTemperatureIncrease(double crossSectionArea, double insulationThickness, String material, double current) {
        ...
        // Berechne den Wärmewiderstand zwischen Leitung und Isolierung
        double thermalResistanceWireToInsulation = calculateThermalResistance(radiusWire, radiusInsulation);

        // Berechne den Wärmewiderstand zwischen Isolierung und Luft
        double thermalResistanceInsulationToAir = calculateThermalResistanceToAir(radiusInsulation);
        ...
        double totalThermalResistance = thermalResistanceWireToInsulation + thermalResistanceInsulationToAir;
