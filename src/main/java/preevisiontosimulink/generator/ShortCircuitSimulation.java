...
public class ShortCircuitSimulation {
    public static void main(String[] args) {
        try {
            ...
            matlab.eval("add_block('fl_lib/Electrical/Electrical Sources/DC Voltage Source', 'ShortCircuitModel/VoltageSource')");
            matlab.eval("add_block('fl_lib/Electrical/Electrical Elements/Resistor', 'ShortCircuitModel/Resistor')");
            matlab.eval("add_block('fl_lib/Electrical/Electrical Elements/Electrical Reference', 'ShortCircuitModel/Ground')");
            ...
            matlab.eval("add_line('ShortCircuitModel', [ position_voltageSource(1).Position ; position_resistor(1).Position])");
            matlab.eval("add_line('ShortCircuitModel', [ position_resistor(2).Position ; position_ground(1).Position])");
